...
# ADD LIB32 /nologo /out:"..\Library\Release\MagicFMvc6.lib"
...
PostBuild_Cmds=copy Approximation2D\*.h ..\Include	copy Approximation2D\*.pkg ..\Include	copy Approximation3D\*.h ..\Include	copy Approximation3D\*.pkg ..\Include	copy Containment2D\*.h ..\Include	copy Containment2D\*.inl ..\Include	copy Containment2D\*.pkg ..\Include	copy Containment3D\*.h ..\Include	copy Containment3D\*.inl ..\Include	copy Containment3D\*.pkg ..\Include	copy Core\*.h ..\Include	copy Core\*.inl ..\Include	copy Core\*.pkg ..\Include	copy Core2D\*.h ..\Include	copy Core2D\*.inl ..\Include	copy Core2D\*.pkg ..\Include	copy Core3D\*.h ..\Include	copy Core3D\*.inl ..\Include	copy Core3D\*.pkg ..\Include	copy Curve2D\*.h ..\Include	copy Curve2D\*.inl ..\Include	copy Curve2D\*.pkg ..\Include	copy Curve3D\*.h ..\Include	copy Curve3D\*.inl ..\Include	copy Curve3D\*.pkg ..\Include	copy Distance2D\*.h ..\Include	copy Distance2D\*.pkg ..\Include	copy Distance3D\*.h ..\Include	copy Distance3D\*.pkg ..\Include	copy ImageAnalysis\*.h ..\Include	copy ImageAnalysis\*.inl ..\Include	copy ImageAnalysis\*.pkg ..\Include	copy Interpolation1D\*.h ..\Include	copy Interpolation1D\*.inl ..\Include	copy Interpolation1D\*.pkg ..\Include	copy Interpolation2D\*.h ..\Include	copy\
                                       Interpolation2D\*.inl ..\Include	copy Interpolation2D\*.pkg ..\Include	copy Interpolation3D\*.h ..\Include	copy Interpolation3D\*.inl ..\Include	copy Interpolation3D\*.pkg ..\Include	copy Intersection2D\*.h ..\Include	copy Intersection2D\*.pkg ..\Include	copy Intersection3D\*.h ..\Include	copy Intersection3D\*.pkg ..\Include	copy Numerics\*.h ..\Include	copy Numerics\*.inl ..\Include	copy Numerics\*.pkg ..\Include	copy Projection\*.h ..\Include	copy Projection\*.inl ..\Include	copy Projection\*.pkg ..\Include	copy Surface\*.h ..\Include	copy Surface\*.inl ..\Include	copy Surface\*.pkg ..\Include	copy Tessellation2D\*.h ..\Include	copy Tessellation2D\*.inl ..\Include	copy Tessellation2D\*.pkg ..\Include	copy Tessellation3D\*.h ..\Include	copy Tessellation3D\*.inl ..\Include	copy Tessellation3D\*.pkg ..\Include	copy MgcRTLib.h ..\Include	copy MagicFMLibType.h ..\Include	copy MagicFM.pkg  ..\Include	copy ..\Include\*.h ..\..\Sdk\Include	copy ..\Include\*.inl ..\..\Sdk\Include	copy ..\Include\*.pkg ..\..\Sdk\Include	copy ..\Library\$(OutDir)\MagicFMvc6.lib ..\..\Sdk\Library\$(OutDir)
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"..\Library\Debug\MagicFMvc6.lib"
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy Approximation2D\*.h ..\Include	copy Approximation2D\*.pkg ..\Include	copy Approximation3D\*.h ..\Include	copy Approximation3D\*.pkg ..\Include	copy Containment2D\*.h ..\Include	copy Containment2D\*.inl ..\Include	copy Containment2D\*.pkg ..\Include	copy Containment3D\*.h ..\Include	copy Containment3D\*.inl ..\Include	copy Containment3D\*.pkg ..\Include	copy Core\*.h ..\Include	copy Core\*.inl ..\Include	copy Core\*.pkg ..\Include	copy Core2D\*.h ..\Include	copy Core2D\*.inl ..\Include	copy Core2D\*.pkg ..\Include	copy Core3D\*.h ..\Include	copy Core3D\*.inl ..\Include	copy Core3D\*.pkg ..\Include	copy Curve2D\*.h ..\Include	copy Curve2D\*.inl ..\Include	copy Curve2D\*.pkg ..\Include	copy Curve3D\*.h ..\Include	copy Curve3D\*.inl ..\Include	copy Curve3D\*.pkg ..\Include	copy Distance2D\*.h ..\Include	copy Distance2D\*.pkg ..\Include	copy Distance3D\*.h ..\Include	copy Distance3D\*.pkg ..\Include	copy ImageAnalysis\*.h ..\Include	copy ImageAnalysis\*.inl ..\Include	copy ImageAnalysis\*.pkg ..\Include	copy Interpolation1D\*.h ..\Include	copy Interpolation1D\*.inl ..\Include	copy Interpolation1D\*.pkg ..\Include	copy Interpolation2D\*.h ..\Include	copy\
